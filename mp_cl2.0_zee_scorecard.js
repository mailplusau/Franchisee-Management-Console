    ...
    function (email, runtime, search, record, http, log, error, url, format,
        ...
        function pageInit() {
            ...
            $("#customer_reviews").click(function () {
                ...
                $("#myModal .modal-body").text('Alexandra has received a notification that you want to improve your scorecard. They will reach out to you with the next steps directly.');
